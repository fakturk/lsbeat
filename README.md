...
`${GOPATH}/src/github.com/fakturk/lsbeat`
...
```
git remote set-url origin https://github.com/fakturk/lsbeat
...
```
mkdir -p ${GOPATH}/src/github.com/fakturk/lsbeat
git clone https://github.com/fakturk/lsbeat ${GOPATH}/src/github.com/fakturk/lsbeat
```
